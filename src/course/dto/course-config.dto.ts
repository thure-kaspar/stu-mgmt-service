...
export class CourseConfigDto {
	...
	@ApiPropertyOptional({ description: "Settings that determine wether groups are allowed, allowed group sizes, etc." })
	...
	@ApiPropertyOptional({ description: "A rule-based description of the necessary requirements to receive admission to the exam or passing a course." })
	admissionCriteria?: AdmissionCriteriaDto;

	/** Templates that can be used in the client to create new assignments. */
	@ApiPropertyOptional({ description: "Templates that can be used in the client to create new assignments." })
