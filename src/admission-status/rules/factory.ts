...
import { AdmissionRule, IndividualPercentWithAllowedFailures, OverallPercentRule, RuleType } from "./abstract-rules";
...
export abstract class AdmissionRuleFactory {
	...
	static create(rule: AdmissionRuleDto, evaluatedAssignments: AssignmentDto[]): AdmissionRule {
		...
		case RuleType.INDIVIDUAL_PERCENT_WITH_ALLOWED_FAILURES: 
			return new IndividualPercentWithAllowedFailuresImpl(rule as IndividualPercentWithAllowedFailures, evaluatedAssignments);
		default: 
