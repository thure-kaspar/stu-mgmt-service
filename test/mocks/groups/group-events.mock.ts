...
export const GROUP_EVENT_ELSHAR_JOINED_GROUP_4_JAVA: GroupEventDto = {
	event: UserJoinedGroupEvent.name,
	timestamp: new Date(2020, 1, 3),
	userId: USER_ELSHAR.id,
...
export const GROUP_EVENT_KUNOLD_JOINED_GROUP_4_JAVA: GroupEventDto = {
	event: UserJoinedGroupEvent.name,
	timestamp: new Date(2020, 1, 4),
	userId: USER_KUNOLD.id,
	groupId: GROUP_4_JAVA.id
...
export const GROUP_EVENTS_MOCK: GroupEventDto[] = [
	...
	GROUP_EVENT_ELSHAR_JOINED_GROUP_4_JAVA,
	GROUP_EVENT_KUNOLD_JOINED_GROUP_4_JAVA
];
